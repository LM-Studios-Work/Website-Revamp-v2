...
export const metadata: Metadata = {
  ...
  description:
    "Data-driven SEO strategies for South African businesses. From local visibility to national reach, LMWebDesign builds the digital foundation that makes you visible exactly when customers are ready to buy.",
  alternates: { canonical: "https://www.lmwebdesign.co.za/services/seo" },
  openGraph: {
    title: "SEO Services South Africa | LMWebDesign",
    description:
      "Data-driven SEO strategies for South African businesses. Local visibility to national reach.",
    url: "https://www.lmwebdesign.co.za/services/seo",
  },
};
