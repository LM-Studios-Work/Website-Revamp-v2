...
export const generalFAQ: FAQItem[] = [
  {
    ...
    answer:
      "We believe in total transparency. Our standard web design packages range from R1,999 to R7,499. For e-commerce stores starting at R8,999 and custom web applications, we provide tailored quotes based on scope and complexity. Check out our Web Design pricing to see exactly what's included.",
  },
  {
...
export const webDesignFAQ: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "We pride ourselves on industry-leading turnaround times. Depending on your chosen package, your brand-new, fully functional website will be designed, built, and launched in just 4 to 12 working days. We deliver speed without ever compromising on quality, security, or design.",
  },
  {
  ...
  {
    question:
      "Will I have to pay expensive monthly retainers after my site goes live?",
    answer:
      "No. We do not lock our clients into expensive, rigid contracts. Every website we build includes a 6-month warranty covering bug fixes and browser compatibility at no extra charge. After that, you operate on a pay-for-what-you-use model with clear, flat-fee pricing for any future updates or new pages.",
  },
  {
    question: "Will my website be mobile-friendly and optimized for Google?",
    answer:
      "Absolutely. Over 60% of web traffic comes from mobile devices, so every site we deploy is 100% mobile-responsive and rigorously tested across Chrome, Safari, and Edge. Furthermore, basic and local SEO optimization is baked into our development process, ensuring your business is structured to rank well on search engines from day one.",
  },
];
...
export const seoFAQ: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "SEO is a marathon, not a sprint. While some technical fixes can yield quick wins in the first month, substantial ranking improvements typically take 3 to 6 months. We build for long-term stability, avoiding quick hacks that risk penalties later.",
  },
  {
    question: "Will you optimize existing content?",
    answer:
      "Yes. Often, you don't need new pages; you just need your existing pages to work harder. We review your current text to ensure it is readable, keyword-rich, and structured in a way that Google's bots can easily understand.",
  },
];
...
export const marketingFAQ: FAQItem[] = [
  {
    ...
    answer:
      "We support paid ads, email marketing, social campaigns and analytics-driven CRO.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "We integrate Google Analytics, Tag Manager, and other tracking tools as needed.",
  },
];
...
export const appDevelopmentFAQ: FAQItem[] = [
  {
    ...
    answer:
      "Every project is unique. We start with a discovery call to understand your requirements, then provide a detailed proposal with timeline and cost estimates tailored to your specific needs.",
  },
  {
    question: "What types of web applications do you build?",
    answer:
      "We build booking systems, inventory management, admin dashboards, workflow automation, CRMs, and other custom business tools. Each solution is designed around your operational requirements.",
  },
  {
    question: "How do you ensure security and scalability?",
    answer:
      "We implement role-based authentication, encrypted data storage, secure APIs, and cloud infrastructure that scales with your organization. Security and reliability are built into every system we create.",
  },
];
