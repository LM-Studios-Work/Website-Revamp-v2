...
export const NavbarContainer = () => {
  return (
    <div className="items-center box-border caret-transparent flex flex-wrap justify-between max-w-none w-full mt-8 mx-auto px-[15px] md:flex-nowrap md:max-w-[1400px]">
      <NavbarLogo />
