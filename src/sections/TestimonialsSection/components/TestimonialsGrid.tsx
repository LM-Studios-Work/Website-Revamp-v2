      ...
      <div className="max-w-[1200px] w-full mx-auto">
        <div className="flex flex-wrap -mx-3">
          ...
          <TestimonialCard
            ...
            testimonial='"A huge thanks to the Web design team of LM Studios for their expert advice, incredible patience, and quick responses. Their dedication made the entire experience smooth and enjoyable. I truly appreciated how attentive and responsive they were throughout the process. I highly recommend their services!"'
          />
          <TestimonialCard
            imageUrl="https://c.animaapp.com/mlaz3dsraozDAl/assets/img_testimonial_materrup.jpg"
            name="Julie Neuville"
            title="Chairwoman | Materrup"
            testimonial='"We have sought LM Studios&#39; assistance in transferring and enhancing certain features of our existing site. Their expertise has enabled us to bring our ideas to life with a high level of customization, a crucial advantage in a context where the website plays a central role in standing out."'
          />
        </div>
      </div>
    </section>
