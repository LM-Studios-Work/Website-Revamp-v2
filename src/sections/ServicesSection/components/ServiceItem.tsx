    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-6 md:gap-12">
          <span className="text-[#C3FF00] text-base md:text-xl font-semibold">
            {props.number}
          </span>
        ...
        <span className="w-8 h-8 md:w-12 md:h-12 bg-[#C3FF00] rounded-full flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
