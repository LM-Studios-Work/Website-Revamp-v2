    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-6 md:gap-12">
          <span className="text-[#e7fe56] text-base md:text-xl font-semibold md:group-hover:scale-110 transition-transform duration-300">
            {props.number}
          </span>
        ...
        <span className="w-8 h-8 md:w-12 md:h-12 bg-[#e7fe56] rounded-full flex items-center justify-center shrink-0 md:group-hover:scale-110 md:group-hover:rotate-45 transition-all duration-300">
          <svg
