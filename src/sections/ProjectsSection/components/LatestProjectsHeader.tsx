...
export const LatestProjectsHeader = () => {
  ...
  return (
    <section ref={ref} className="relative z-10 pt-10 md:pt-20 px-6">
      <div className="max-w-[1400px] w-full mx-auto">
        <div className="flex flex-col md:flex-row items-start md:items-center md:justify-between">
          <h2 className={`text-4xl md:text-[50px] font-bold leading-tight text-white mb-6 md:mb-0 text-balance transition-all duration-600 ${
