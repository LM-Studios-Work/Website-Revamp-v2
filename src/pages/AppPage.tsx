      ...
      <section className="relative py-16 md:py-28 px-6">
        <div className="max-w-[1400px] w-full mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="backdrop-blur-sm bg-white/5 border border-white/10 p-8 rounded-2xl text-center">
          ...
          <div className="flex flex-col md:flex-row md:items-start gap-10 md:gap-16">
            ...
            <div className="md:w-7/12">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="backdrop-blur-sm bg-white/5 border border-white/10 text-white p-8 rounded-2xl">
