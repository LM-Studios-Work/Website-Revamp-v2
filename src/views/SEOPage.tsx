            ...
            <div className="flex flex-col md:flex-row items-start gap-10 md:gap-20">
              ...
              >
                ...
                <p className="text-lg text-white/70 leading-relaxed">
                  ...
                  for your first leads, we build the digital foundation that
                  makes you visible.
                </p>
              </div>
              <div
            ...
            <div className="flex flex-col md:flex-row md:items-start gap-10 md:gap-16">
              <div className="md:w-5/12 shrink-0">
                ...
                <p className="text-base text-white/60 leading-relaxed">
                  A proven methodology that drives sustainable ranking
                  improvements and qualified traffic.
                </p>
              </div>
            </div>
          }
          cards={[
            {
              ...
              title: "The Audit",
              description:
                "We dive deep into your current site health, analyzing technical errors, competitor rankings, and missed local opportunities to establish a baseline.",
            },
            {
              step: 2,
              variant: "cyan",
            ...
            },
            {
              ...
              title: "The Climb",
              description:
                "Execution begins. We optimize your content for local search terms and build the citations needed to prove your authority to Google.",
            },
          ]}
        />
        ...
        <SectionWrapper>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-white/60 mt-6 max-w-3xl mx-auto">
              From local visibility to national reach. Choose a package that
              fits your goals, or contact us for a custom strategy tailored to
              your business.
            </p>
          </div>
          ...
          <div className="mt-12 text-center">
            <p className="text-lg text-white/70 mb-6 max-w-2xl mx-auto">
              Not sure which package fits your needs? Contact us for a free
              consultation and custom proposal tailored to your business goals.
            </p>
            <Link
              href="/contact"
              className="inline-flex items-center text-base font-semibold bg-[#d5bff0] text-black pl-8 pr-3 py-3 rounded-full hover:bg-[#d5bff0]/90 hover:scale-105 transition-all duration-300"
